...

  {
    ...
    if(   (c=='n' || c=='N')
      ...
      (*address_of_string_pointer)+=3;
      return 0;
    }
    if(   (c=='i' || c=='I') 
       && (first_digit[1]=='n' || first_digit[1]=='N')
       && (first_digit[2]=='f' || first_digit[2]=='F')) {
      address_of_generic_floating_point_number->sign='P';
      address_of_generic_floating_point_number->exponent=0;
      address_of_generic_floating_point_number->leader=address_of_generic_floating_point_number->low;
      (*address_of_string_pointer)+=3;
      return 0;
    ...
    if (c=='-' || c=='+')
      {
        if(   (first_digit[1]=='i' || first_digit[1]=='I')
	   && (first_digit[2]=='n' || first_digit[2]=='N')
	   && (first_digit[3]=='f' || first_digit[3]=='F')) {
	  address_of_generic_floating_point_number->sign = (c=='+') ? 'P' : 'N';
	  address_of_generic_floating_point_number->exponent=0;
	  address_of_generic_floating_point_number->leader=address_of_generic_floating_point_number->low;
	  (*address_of_string_pointer)+=4;
	  return 0;
	}
	digits_sign_char = c;
        first_digit ++;
